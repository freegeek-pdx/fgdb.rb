class AdminController < ApplicationController
  ...
  def set_model
    ...
    @models = ["report_logs", "actions", "attendance_types", "call_status_types", "community_service_types", "contact_method_types", "contact_types", "contracts", "customizations", "defaults", "disbursement_types", "disciplinary_action_areas", "discount_names", "discount_percentages", "generics", "gizmo_categories", "gizmo_contexts", "gizmo_type_groups", "gizmo_types", "holidays", "income_streams", "jobs", "mailings", "meeting_minders", "pay_periods", "payment_methods", "postal_codes", "pricing_datas", "pricing_types_types", "privileges", "programs", "recycling_shipments", "resources", "return_policies", "roles", "rosters", "rr_items", "rr_sets", "sale_types", "schedules", "skeds", "spec_sheet_question_conditions", "spec_sheet_questions", "till_adjustments", "till_types", "types", "volunteer_task_types", "warranty_lengths", "wc_categories", "weekdays", "worker_types"]
    if params[:model]
